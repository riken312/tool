...
<html lang="en">
  <head>
    ...
    <title>D'source Tool Sign-up</title>
    ...
    <div class="row">
      ...
      <div class="col-md-offset-4 col-md-4">
        ...
        <div class="row form-group"> 
          ...
          <input id="forUsername" class="form-control" type="text" name="user_name" placeholder="Enter user-name"/>
        </div> 
        <div class="row form-group"> 
        ...
        <hr>
        <p class="bg-info big-box">Have already sign-up?<a href="log-in.php"> Log-in</a> instead?</p>
