          ...
          <div class="row">
            <div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/1.jpg" alt="...">
              </a>
            </div>
            <div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/2.jpg" alt="...">
              </a>
            </div><div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/3.jpg" alt="...">
              </a>
            </div><div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/4.jpg" alt="...">
              </a>
            </div><div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/5.jpg" alt="...">
              </a>
            </div><div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/6.jpg" alt="...">
              </a>
            </div><div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/7.jpg" alt="...">
              </a>
            </div><div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/8.jpg" alt="...">
              </a>
            </div><div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/9.jpg" alt="...">
              </a>
            </div><div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/10.jpg" alt="...">
              </a>
            </div><div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/11.jpg" alt="...">
              </a>
            </div><div class="col-md-2 other-img">
              <a href="#" class="thumbnail">
                <img src="img/batch-1/12.jpg" alt="...">
              </a>
            </div>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      ...
                      <div class="cat-label"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Color </div>
                        ...
                        <button class="color-button" style="background-color:#FCFAC1"></button>
                      ...
                      <div class="cat-label"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Basic Shape</div>
                        <div class="btn-group-xs" data-toggle="buttons">
                          ...
                          <label class="btn btn-primary">
                            <input type="checkbox" autocomplete="off">O
                          </label>
                          <label class="btn btn-primary">
                            <input type="checkbox" autocomplete="off">O
                          </label>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <div class="cat-label"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Purpose </div>
                        <div class="btn-group btn-group-xs" data-toggle="buttons">
                          <label class="btn btn-primary">
                            <input type="checkbox" autocomplete="off">Decoration
                          </label>
                          <label class="btn btn-primary">
                        ...
                        <div class="btn-group btn-group-xs" data-toggle="buttons">  
                          <label class="btn btn-primary">
                            <input type="checkbox" autocomplete="off">Religious
                          </label>
                          <label class="btn btn-primary">
